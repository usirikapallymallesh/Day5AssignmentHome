...
const Lorm = () => {
  ...
  const onclickHandler = () => {
    ...
    // console.log(Data.slice(0, userInputNumber));
    if (userInput == "") {
    ...
    setCount(Data.slice(0, userInputNumber));
  ...
  return (
    <div style={{ width: "80%" }}>
      ...
      {count.map((item, index) => {
        return (
          <p key={index} style={{ padding: "10px 0", color: "blue" }}>
            {item}
          </p>
        );
      })}
